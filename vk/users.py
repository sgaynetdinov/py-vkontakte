...
class UserCareer(VKBase):
    ...
    def from_json(cls, session, json_obj):
        ...
        career.country = Country._get_country_by_id(json_obj.get("country_id"))
        career.city = City._get_city_by_id(json_obj.get("city_id"))
...
class UserSchool(VKBase):
    ...
    def from_json(cls, session, school_json):
        ...
        school.country = Country._get_country_by_id(school_json.get("country"))
        school.city = City._get_city_by_id(school_json.get("city"))
...
class UserUniversity(VKBase):
    ...
    def from_json(cls, session, university_json):
        ...
        university.country = Country._get_country_by_id(university_json.get("country"))
        university.city = City._get_city_by_id(university_json.get("city"))
